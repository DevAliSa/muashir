  ...
  return (
    <div className="py-20 md:py-36 text-center mx-8 animate-fade-in ">
      <h2 className="bg-clip-text  text-transparent text-center bg-linear-to-b from-neutral-400 to-neutral-600 dark:from-neutral-700 dark:to-neutral-400 text-2xl md:text-4xl lg:text-7xl  py-2 md:py-10 relative z-20 font-bold tracking-tight">
        {t('HomePage.title1')}
        <br /> {t('HomePage.title2')} <Cover> {t('HomePage.title3')}</Cover>
      </h2>
      ...
      <div className="grid animate-fade-in grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-8 mx-8 ">
        <div className="card-wrapper h-48 relative overflow-hidden">
          <CardTitle className="card-content p-4  text-lg font-bold  mb-6 dark:text-neutral-900 relative">
            ...
            {t('SampleCard.title1')}
            <p className=" font-normal mt-1 text-sm dark:text-neutral-900">
              {t('SampleCard.description1')}
            </p>
          </CardTitle>
          <FlickeringGrid
        ...
        <div className="card-wrapper h-48 relative overflow-hidden">
          <CardTitle className="card-content p-4  text-lg font-bold   mb-6 dark:text-neutral-900 relative">
            ...
            {t('SampleCard.title2')}
            <p className=" font-normal text-sm dark:text-neutral-900">
              {t('SampleCard.description2')}
            </p>
          </CardTitle>
          <FlickeringGrid
            className="relative inset-0 z-0 mask-[radial-gradient(450px_circle_at_center,white,transparent)]"
